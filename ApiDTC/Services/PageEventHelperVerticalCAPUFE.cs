...
//Encabezado primera pagina 
            ...
            if (pageN == 1)
            {
                ...
                var colFecha = new PdfPCell(new Phrase(_Informacion.Rows[0]["Fecha"].ToString(), letraNormalChica)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_CENTER, Padding = 3 };
            ...
            var colPlaza = new PdfPCell(new Phrase("Plaza de Cobro No: "+ _Informacion.Rows[0]["Numero"] + " Nombre " + _Informacion.Rows[0]["Nombre"], letraNormalChica)) { BorderWidthTop = 1, BorderWidthBottom = 1, BorderWidthLeft = 1, BorderWidthRight = 1, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_CENTER, Padding = 3, PaddingRight =5, Colspan = 2 };
            var colCarril = new PdfPCell(new Phrase("Carril No: "+_carril[1]+_carril[2]+ ", Cuerpo " + _carril[0], letraNormalChica)) { BorderWidthTop = 1, BorderWidthBottom = 1, BorderWidthLeft = 1, BorderWidthRight = 1, HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_CENTER, Padding = 3, Colspan = 2 };
