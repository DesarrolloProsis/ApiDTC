namespace ApiDTC.Data
{
    ...
    public class RequestedComponentDb
    {
        ...
        #region Constructor
        public RequestedComponentDb(IConfiguration configuration, SqlResult sqlResult, ApiLogger apiLogger)
        {
        ...
        #region Methods
        public Response PostRequestedComponent(string clavePlaza, List<RequestedComponent> requestedComponent, bool flag)
        {
            try
            {
            ...
            {
                _apiLogger.WriteLog(clavePlaza, ex, "RequestedComponentDb: PostRequestedComponentOpen", 1);
                return new Response { Message = $"Error: {ex.Message}", Result = null };
            }            
        }

        public Response PostRequestedComponentOpen(string clavePlaza, List<RequestedComponentOpen> requestedComponent, bool flag)
        {
            try
            {
                using (SqlConnection sql = new SqlConnection(_connectionString))
